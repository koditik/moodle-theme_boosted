...
// About text.
    ...
    $output .= '<p><b>The Font Awesome v4.7 (by Dave Gandy) is licensed under:</b><br>
                SIL Open Font License v1.1 - <a href="https://scripts.sil.org/OFL" target="_blank">
                https://scripts.sil.org/OFL</a><br>
                Font Awesome CSS, LESS, and SASS files are licensed under MIT License
                 - <a href="https://opensource.org/licenses/mit-license.html" target="_blank">
                https://opensource.org/licenses/mit-license.html</a></p>';
